  ...
  return (
    <nav className="flex justify-between items-center bg-[#0A0A0A] px-6">
      ...
      <div className="inline-flex rounded-md shadow-sm" role="group">
        <Link to="/" className={`flex gap-2 items-center rounded-s-xl p-3 h-[40px] font-[600] ${useLocation().pathname === "/" ? "bg-white text-black" : "bg-transparent text-[#A4A4A4] border border-[#5D5D5D]"}`}>
        ...
        <Link to="/favoritos" className={`flex gap-2 items-center rounded-e-xl p-3 h-[40px] font-[600] ${useLocation().pathname === "/favoritos" ? "bg-white text-black" : "bg-transparent text-[#A4A4A4] border border-[#5D5D5D]"}`}>
