  ...
  return (
    <nav className="flex justify-between items-center bg-[#0A0A0A] px-6">
      ...
      <div className="inline-flex rounded-md shadow-sm" role="group">
        <Link href="/" className={`flex gap-2 items-center rounded-s-xl p-3 h-[40px] font-[600] ${useLocation().pathname === "/" ? "bg-white text-black" : "bg-transparent text-[#A4A4A4] border border-[#5D5D5D]"}`}>
          <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill={useLocation().pathname === "/" ? "black" : "#A4A4A4"} className="w-6 h-6">
        ...
        <Link href="/favoritos" className={`flex gap-2 items-center rounded-e-xl p-3 h-[40px] font-[600] ${useLocation().pathname === "/favoritos" ? "bg-white text-black" : "bg-transparent text-[#A4A4A4] border border-[#5D5D5D]"}`}>
          <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill={useLocation().pathname === "/favoritos" ? "black" : "#A4A4A4"} className="w-6 h-6">
          ...
          Favoritos
          <div className={`flex justify-center items-center rounded-full h-[20px] min-w-[20px] px-1 pt-[1px] text-black ${useLocation().pathname === "/favoritos" ? "bg-transparent border border-black" : "bg-white"}`}>
            {favoriteCount}
          </div>
        </Link>
      </div>
